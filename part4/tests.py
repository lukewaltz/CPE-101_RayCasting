...
class TestData(unittest.TestCase):
    ...
    def test_sphere_1(self):
        ...
        finish1 = 0.2
        sphere1 = data.sphere(pt1, radius1, color1, finish1)
    ...
    def test_sphere_2(self):
        pt2 = data.point(3, 9, 5)
        radius2 = 8.65
        color2 = data.color(0, 0, 255)
        finish2 = 0.4
        sphere2 = data.sphere(pt2, radius2, color2, finish2)
    ...
    def test_find_intersection_points_1(self):
        ...
        color1 = data.color(255, 0, 0)
        finish1 = 0.2
        sphere1 = data.sphere(center1, radius1, color1, finish1)
        center2 = data.point(3, 2, 0)
        radius2 = 2
        color2 = data.color(0, 0, 255)
        finish2 = 0.4
        sphere2 = data.sphere(center2, radius2, color2, finish2)
